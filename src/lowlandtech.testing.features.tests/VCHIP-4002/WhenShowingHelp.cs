...
public sealed class WhenShowingHelp(ITestOutputHelper output) : WhenTestingForAsync<CliApp>
{
    ...
    [Fact]
    [Then("Shows 'coverage' command", "VCHIP-4002-UAC001")]
    public void ShowsCoverage() => _result!.Output.Contains("coverage").ShouldBeTrue();

    [Fact]
    [Then("Shows 'report' command", "VCHIP-4002-UAC002")]
